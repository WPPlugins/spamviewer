...
if(function_exists('load_plugin_textdomain'))
	load_plugin_textdomain('spamviewer','wp-content/plugins');
...
?>
	<div class="wrap">
		...
		<form method="post" action="<?php echo $fbtbv_link; ?>&amp;action=tb_killed" name="form1">
			<input class="submit" type="submit" name="Submit_tb_data" value="<?php _e('Trackback-Spam - All delete!', 'spamviewer'); ?>" />
		...
		<form method="post" action="<?php echo $fbtbv_link; ?>&amp;action=comment_killed" name="form2">
			<input type="submit" name="Submit_comments" value="<?php _e('Comment Spam - Delete All!&nbsp;', 'spamviewer'); ?>" />
...
<?php if ($spam_count != 0) { ?>  
	<h2><a name="tbe" id="tbe"></a><?php _e('Trackback-Spam', 'spamviewer'); ?> <small><?php echo $paginationMsg; ?></small></h2>
		<p>
			<input type="hidden" name="action" value="unspam" />
			<input class="submit" type="submit" name="submit" value="<?php _e('Unspam me!', 'spamviewer'); ?>" />   
		</p>
		<table id="fb_trspam" border="0" summary="FB TRSpam" width="100%" cellpadding="3" cellspacing="3">
			<tr>
	...
	?>
		...
		<p>
			<input class="submit" type="submit" name="submit" value="<?php _e('Unspam me!', 'spamviewer'); ?>" />
			<span style="float: right;"><a href="#top"><?php _e('Top', 'spamviewer'); ?></a></span>
		</p>
<?php } // endif tb_data
	if ($count != 0) { ?>
	<h2><a name="commente" id="commente"></a><?php _e('Comment-Spam', 'spamviewer'); ?> <small><?php echo $paginationMsg; ?></small></h2>
		<p>
		...
		<table id="fb_commentspam" border="0" summary="FB CommentSpam" width="100%" cellpadding="3" cellspacing="3">
			<tr>
				<th style="text-align:center; width:7%;"><?php _e('Unspam?', 'spamviewer'); ?></th>
				<th style="text-align:center; width:7%;"><?php _e('ID', 'spamviewer'); ?></th>
				<th style="text-align:center; width:7%;"><?php _e('Post-ID', 'spamviewer'); ?></th>
